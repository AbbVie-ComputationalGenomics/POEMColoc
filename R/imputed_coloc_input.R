...
#' @param subset
#' optional parameter that is the path to a file giving the names of samples to include as formatted in the gds file or vcf from which it came.  each line should be the name of a sample.
#' @param R2
